...
public class LandContigFilterClient {
     ...
     * </pre>
     * @param   params   instance of type {@link us.kbase.landcontigfilter.FilterContigsParams FilterContigsParams}
    ...
    public FilterContigsResults filterContigs(FilterContigsParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<FilterContigsResults> res = caller.jsonrpcCall("landContigFilter.filter_contigs", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
