...
function landContigFilter(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.filter_contigs = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "landContigFilter.filter_contigs",
     ...
     this.filter_contigs_max = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "landContigFilter.filter_contigs_max",
            [params], 1, _callback, _errorCallback);
    };
     ...
     this.assembly_metadata_report = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax(_url, "landContigFilter.assembly_metadata_report",
            [params], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "landContigFilter.status",
