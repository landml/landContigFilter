...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'landContigFilter'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from landContigFilter.landContigFilterImpl import landContigFilter  # noqa @IgnorePep8
impl_landContigFilter = landContigFilter(config)
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_landContigFilter.assembly_metadata_report,
                             ...
                             types=[dict])
        self.method_authentication['landContigFilter.assembly_metadata_report'] = 'required'  # noqa
